...
profileEdit.addEventListener('click', function (){   //Открытие попапа редактирования профиля по клику
  addValueToTextcontent(popupEdit)    //вызываем функцию, которая подставляет значения имени и профессии в поля инпут с нужным попапом
  openPopup(popupEdit)   
}); 
...
//ФУНКЦИЯ ДОБАВЛЕНИЯ КАРТОЧКИ ЧЕРЕЗ ФОРМУ, ЛАЙК, УДАЛЕНИЕ 
